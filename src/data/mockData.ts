...
export const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    content: "We came to UAE with no proper itinerary. Mariya at Airwings has helped us every set of the way from helping us get visas, to getting us a chauffeured car to explore the city, and getting reasonable tickets to the best places in town. Would highly recommend Airwings for any travel or booking needs",
    trip: "UAE Visa and City Tour",
  },
  {
    id: "2",
    ...
    rating: 5,
    content: "Just wanted to thank you, I gave your number to so many of my friends. And they took your service for visa and they all are very happy. Infact they were thanking me that i shared your number with them. 😇 Thanks for your good service",
    trip: "Visa Services",
  },
  {
    id: "3",
    ...
    rating: 5,
    content: "Good morning madam journey was excellent we want to thank you for the great professional service provided by you at all times excellent 👌 We will surely come back to you for future travel plans which will be sooner",
    trip: "UAE Journey Package",
  },
  {
    id: "4",
    ...
    rating: 5,
    content: "Good morning ma'am journey was excellent we want to thank you for the great professional service. We felt secure all the time. Mr. Rajesh was a great driver and very supportive and very well mannered. We didn't click any pictures but memories will last forever. For sure we will recommend your services. 😊",
    trip: "Chauffeured UAE Tour",
  },
];
